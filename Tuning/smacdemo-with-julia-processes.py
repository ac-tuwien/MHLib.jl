...
In this variant individual Julia processes are started for all function evaluations.
While this allows parallelization even on the cluster, it is not very efficient
